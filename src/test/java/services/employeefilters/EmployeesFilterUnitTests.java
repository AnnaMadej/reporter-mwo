...
public class EmployeesFilterUnitTests {
    ...
    public final void testsAsksForPossibleData() {
        ...
        Mockito.when(retriever.getPossibleData(Mockito.anyList())).thenReturn(new TreeSet<String>());
    ...
    public final void testReturnsPossibleDataRetriever() {
        ...
        Assert.assertTrue(filter.getPossibleDataRetriever() instanceof PossibleYearRetriever);
    }
