...
public class Report3BuilderTest {
	...
	public final void testCountsHoursCorrectly() {
		...
		Assert.assertTrue(report.getRows().stream()
				.anyMatch(r -> (r.get(1).equals("Czerwiec") && r.get(2).equals("projekt1") && r.get(3).equals("1.0"))));
		Assert.assertTrue(report.getRows().stream().anyMatch(
				r -> (r.get(1).equals("Pażdziernik") && r.get(2).equals("projekt2") && r.get(3).equals("20.0"))));
		Assert.assertTrue(report.getRows().stream().anyMatch(
				r -> (r.get(1).equals("Pażdziernik") && r.get(2).equals("projekt3") && r.get(3).equals("2.0"))));
	}
